<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="successfulTrade.aspx.cs" Inherits="sucessTrade" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p  style="height: 40px;margin-top:10px;margin-left:45px;font-size:20px;font-weight:bold; padding-bottom:10px;">主动成功的交易记录</p>
    <div class="div_rq_sent" style="padding-left:60px;">
    <asp:GridView ID="GridView1" Cssclass="border_rq_sent" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Exchange_ID" DataSourceID="SqlDataSource1" PageSize="5">
        <Columns>
     ...
     <p  style="height: 40px;margin-top:10px;margin-left:45px;font-size:20px;font-weight:bold; padding-bottom:10px;">被动成功的交易记录</p>
    <div class="div_rq_sent" style="padding-left:60px;">
        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Exchange_ID" DataSourceID="SqlDataSource2" PageSize="6" Width="627px">
            <Columns>
                <asp:BoundField DataField="Exchange_ID" HeaderText="交换单号" InsertVisible="False" ReadOnly="True" SortExpression="Exchange_ID" />
